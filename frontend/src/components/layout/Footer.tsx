        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed max-w-xs">
              Experience the future of online shopping with ModernStore. We provide the best quality products with fastest delivery services.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/account/profile" className="hover:text-white transition-colors">My Account</Link></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                <span>123 Shopping Avenue, Commerce City, ST 12345</span>
              </li>
